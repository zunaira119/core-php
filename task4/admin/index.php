    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li>
                    <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-bell fa-fw"></i></a>
                        <ul style="margin-right: 0.5%;padding: 1px 6px 6px 7px;" class=" notification dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">   
                        </ul>
                </li>
            </ul>
        </nav>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Marchents</div>
                                     <?php
                                         $sql = " SELECT * FROM users WHERE type = 'marchent'";
                                        $result = $conn->query($sql);
                                        $count=mysqli_num_rows($result);
                                        echo '<strong style="text-align:center;">'.$count.'</strong>';
                                         // $conn->close();
                                        ?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Completed Requests</div>
                                     <?php
                                         $sql3 = " SELECT * FROM requests WHERE status = 'done'";
